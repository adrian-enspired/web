<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        <div class="round align-self-center round-info"><i class="ti-music-alt"></i></div>
                        <div class="m-l-10 align-self-center">
                            <h3 class="m-b-0">{{ $release_count }}</h3>
                            <h5 class="text-muted m-b-0">Total Releases</h5></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title m-b-0">New User List</h5>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title m-b-0">New Release List</h5>
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach ($releases as $release)
                                    <tr>
                                        ...
                                        <td>{{ $release->created_at->format('M, d Y H:m:s') }}</td>
                                        <td>
